      ...
      <div className="space-y-8">
        <Card className="bg-white dark:bg-gray-800 shadow-lg">
          <CardHeader className="text-center">
            <h1 className="text-5xl font-extrabold text-primary dark:text-primary mb-2">{personalDetails.name}</h1>
        ...
        <Card className="bg-white dark:bg-gray-800 shadow-lg">
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-primary dark:text-primary flex items-center gap-2"><User size={24} /> Détails Personnels</CardTitle>
          </CardHeader>
